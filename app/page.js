      ...
      <section className="loyalty">
        <div className="wrap">
          ...
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center' }}>
            <a href="#" className="btn btn--dark">Daftar Sekarang</a>
            <a href="#" className="btn btn--outline" style={{ color: 'var(--ink)', borderColor: 'var(--ink)' }}>Masuk</a>
          </div>
        </div>
      </section>
      ...
      <section className="section" id="tentang" style={{ background: 'var(--ink)', color: '#fff' }}>
        <div className="wrap">
          <div className="section-head" style={{ border: 'none' }}>
            <div>
              <span className="eyebrow" style={{ color: 'rgba(255,255,255,.5)' }}>Dipercaya Ribuan Pembeli</span>
              <h2 style={{ color: '#fff' }}>Angka Bicara</h2>
            </div>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 24 }}>
            <div><div className="display" style={{ fontSize: 48 }}>10K+</div><p style={{ color: 'rgba(255,255,255,.6)', fontSize: 13, marginTop: 4 }}>Produk Terjual</p></div>
            <div><div className="display" style={{ fontSize: 48 }}>500+</div><p style={{ color: 'rgba(255,255,255,.6)', fontSize: 13, marginTop: 4 }}>Tim &amp; Komunitas</p></div>
            <div><div className="display" style={{ fontSize: 48 }}>4.9</div><p style={{ color: 'rgba(255,255,255,.6)', fontSize: 13, marginTop: 4 }}>Rating Rata-rata</p></div>
            <div><div className="display" style={{ fontSize: 48 }}>100%</div><p style={{ color: 'rgba(255,255,255,.6)', fontSize: 13, marginTop: 4 }}>Custom Sesuai Desain</p></div>
          </div>
        </div>
      </section>
    </>
